      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="text-gray-700">
                  <strong>Opt-out:</strong> <a href="https://tools.google.com/dlpage/gaoptout" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">Google Analytics Opt-out</a>
                </p>
              </div>

              <div className="bg-gray-50 p-4 rounded-lg">
                <h4 className="font-semibold text-gray-800 mb-2">App Store Analytics</h4>
                <p className="text-gray-700 mb-2">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">4.1 Cookie Consent Management</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">4.2 Managing Your Preferences</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">4.3 Browser Settings</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. Regional Compliance</h2>
            
            <h3 className="text-xl font-semibold text-gray-800 mb-3">5.1 European Union (GDPR/ePrivacy)</h3>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">5.2 California (CCPA/CPRA)</h3>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">5.3 Other Regions</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">6. Children's Privacy (COPPA)</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-gray-700 mb-2">Email: privacy@ausmoapp.com</p>
