  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-black dark:text-white mb-8">Cookie Policy</h1>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-green-500 dark:border-green-400 pl-4">
                <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">Essential Cookies</h3>
              ...
              <div className="border-l-4 border-blue-500 dark:border-blue-400 pl-4">
                <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">Analytics Cookies</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-2">
              ...
              <div className="border-l-4 border-accent-500 dark:border-accent-400 pl-4">
                <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">Functional Cookies</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-2">
              ...
              <div className="border-l-4 border-red-500 dark:border-red-400 pl-4">
                <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">Marketing Cookies</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-2">
          ...
          <section>
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-2">
                  <strong>Privacy Policy:</strong> <a href="https://policies.google.com/privacy" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer">Google Privacy Policy</a>
                </p>
                <p className="text-gray-700 dark:text-gray-300">
                  <strong>Opt-out:</strong> <a href="https://tools.google.com/dlpage/gaoptout" className="text-blue-600 dark:text-blue-400 hover:underline" target="_blank" rel="noopener noreferrer">Google Analytics Opt-out</a>
                </p>
              </div>

              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">App Store Analytics</h4>
                <p className="text-gray-700 dark:text-gray-300 mb-2">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">4.1 Cookie Consent Management</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">4.2 Managing Your Preferences</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">4.3 Browser Settings</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">5.1 European Union (GDPR/ePrivacy)</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">5.2 California (CCPA/CPRA)</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">5.3 Other Regions</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-2">Email: privacy@ausmoapp.com</p>
