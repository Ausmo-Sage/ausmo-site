  ...
  return (
    <main className="min-h-screen bg-white dark:bg-[#1A1F2E]">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-[#2C3E50] dark:text-[#E8EDF2] mb-8">DMCA Policy</h1>
        ...
        <div className="bg-[#FFF4E6] dark:bg-[#252B3B] rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">1. DMCA Compliance</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">2. Reporting Copyright Infringement</h2>
            
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">2.1 DMCA Takedown Notice</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
            ...
            <div className="bg-[#D4E7F7] dark:bg-[#1A1F2E] p-4 rounded-lg mb-4 border border-[#E8EEF2] dark:border-[#6B5B8C]">
              <h4 className="font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-2">Required Information:</h4>
              <ol className="list-decimal pl-4 text-[#2C3E50] dark:text-[#E8EDF2] text-sm space-y-1">
            ...
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">2.2 How to Submit a Notice</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">3. Response to DMCA Notices</h2>
            
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">3.1 Processing Timeline</h3>
            ...
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">3.2 Counter-Notification</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">4. Repeat Infringer Policy</h2>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">6. Fair Use Considerations</h2>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">7. International Considerations</h2>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">8. False Claims</h2>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            ...
            <div className="bg-[#D4E7F7] dark:bg-[#1A1F2E] p-4 rounded-lg">
              <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-2"><strong>DMCA Agent:</strong></p>
              <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-2">Email: dmca@ausmoapp.com</p>
              <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-2">Phone: +1 (555) 123-DMCA (3622)</p>
              <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-2">Address: 123 Communication Ave, Accessibility City, AC 12345</p>
              <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-2">Attn: DMCA Agent</p>
              
              <p className="text-[#2C3E50] dark:text-[#E8EDF2] mt-4 mb-2"><strong>General Legal:</strong></p>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">10. Updates to This Policy</h2>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
