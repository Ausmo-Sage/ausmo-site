  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">COPPA Compliance Statement</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">1. What is COPPA?</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">2. Our Commitment to Children's Privacy</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">3. Information We Collect from Children</h2>
            
            <h3 className="text-xl font-semibold text-gray-800 mb-3">3.1 With Parental Consent</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">3.2 Without Parental Consent</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. How We Obtain Parental Consent</h2>
            
            <h3 className="text-xl font-semibold text-gray-800 mb-3">4.1 Verifiable Consent Methods</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">4.2 Consent Process</h3>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. How We Use Children's Information</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">7. Parental Rights and Controls</h2>
            
            <h3 className="text-xl font-semibold text-gray-800 mb-3">7.1 Parental Rights</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">7.2 How to Exercise Rights</h3>
            <p className="text-gray-700 mb-4">
              Parents can exercise their rights by:
            </p>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li>Logging into their parent account dashboard</li>
              <li>Using our <a href="/data-rights" className="text-blue-600 hover:underline">Data Rights Request Form</a></li>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">8. Data Security and Retention</h2>
            
            <h3 className="text-xl font-semibold text-gray-800 mb-3">8.1 Security Measures</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">8.2 Data Retention</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">9. International Compliance</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-gray-700 mb-2"><strong>COPPA Compliance Officer:</strong></p>
              <p className="text-gray-700 mb-2">Email: coppa@ausmoapp.com</p>
              <p className="text-gray-700 mb-2">Phone: +1 (555) 123-COPPA (2677)</p>
              <p className="text-gray-700 mb-2">Address: 123 Communication Ave, Accessibility City, AC 12345</p>
              
              <p className="text-gray-700 mt-4 mb-2"><strong>Federal Trade Commission:</strong></p>
              <p className="text-gray-700 mb-2">Website: <a href="https://www.ftc.gov" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">www.ftc.gov</a></p>
              <p className="text-gray-700 mb-2">COPPA Hotline: 1-877-FTC-HELP</p>
            </div>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">11. Updates to This Statement</h2>
            <p className="text-gray-700 mb-4">
