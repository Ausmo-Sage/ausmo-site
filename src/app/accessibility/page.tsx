  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-black dark:text-white mb-8">Accessibility Statement</h1>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">1. Our Commitment to Accessibility</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">2. Accessibility Standards</h2>
            
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">2.1 WCAG 2.1 Compliance</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">2.2 Legal Compliance</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">3. Accessibility Features</h2>
            
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">3.1 Website Accessibility</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">3.2 Mobile App Accessibility</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">4. Assistive Technology Support</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Screen Readers</h4>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Switch Control</h4>
                <ul className="list-disc pl-4 text-gray-700 dark:text-gray-300 text-sm">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Magnification</h4>
                <ul className="list-disc pl-4 text-gray-700 dark:text-gray-300 text-sm">
                  <li>ZoomText</li>
                  <li>MAGic</li>
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Voice Control</h4>
                <ul className="list-disc pl-4 text-gray-700 dark:text-gray-300 text-sm">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">5. Testing and Evaluation</h2>
            
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">5.1 Testing Methods</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">5.2 Testing Tools</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">6. Known Issues and Limitations</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">7. Feedback and Support</h2>
            
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">7.1 Reporting Accessibility Issues</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
              ...
              <li><strong>Online Form:</strong> <a href="/accessibility-feedback" className="text-blue-600 dark:text-blue-400 hover:underline">Accessibility Feedback Form</a></li>
              <li><strong>Mail:</strong> 123 Communication Ave, Accessibility City, AC 12345</li>
            </ul>

            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">7.2 Response Time</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">8. Alternative Access Methods</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">9. Training and Awareness</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">10. Future Improvements</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
              <p className="text-gray-700 dark:text-gray-300 mb-2"><strong>Accessibility Coordinator:</strong></p>
              <p className="text-gray-700 dark:text-gray-300 mb-2">Email: accessibility@ausmoapp.com</p>
              <p className="text-gray-700 dark:text-gray-300 mb-2">Phone: +1 (555) 123-ACCESS (2223)</p>
              <p className="text-gray-700 dark:text-gray-300 mb-2">TTY: +1 (555) 123-TTYY (8899)</p>
              <p className="text-gray-700 dark:text-gray-300 mb-2">Address: 123 Communication Ave, Accessibility City, AC 12345</p>
              
              <p className="text-gray-700 dark:text-gray-300 mt-4 mb-2"><strong>Business Hours:</strong></p>
              <p className="text-gray-700 dark:text-gray-300 mb-2">Monday - Friday: 9:00 AM - 6:00 PM (EST)</p>
              <p className="text-gray-700 dark:text-gray-300 mb-2">Saturday: 10:00 AM - 4:00 PM (EST)</p>
              <p className="text-gray-700 dark:text-gray-300 mb-2">Sunday: Closed</p>
            </div>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">12. Updates to This Statement</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
