  ...
  return (
    <main className="min-h-screen bg-white dark:bg-[#1A1F2E]">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold text-[#2C3E50] dark:text-[#E8EDF2] mb-8">Terms of Service</h1>
        ...
        <div className="bg-[#FFF4E6] dark:bg-[#252B3B] rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">2. Description of Service</h2>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">3. User Accounts and Registration</h2>
            
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">3.1 Account Creation</h3>
            <ul className="list-disc pl-6 text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">3.2 Age Requirements</h3>
            <ul className="list-disc pl-6 text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">4. Acceptable Use</h2>
            
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">4.1 Permitted Uses</h3>
            <ul className="list-disc pl-6 text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">4.2 Prohibited Uses</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">You may not use the Service to:</p>
            <ul className="list-disc pl-6 text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">5. User-Generated Content</h2>
            
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">5.1 Content Ownership</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">5.2 Content Standards</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">All uploaded content must:</p>
            <ul className="list-disc pl-6 text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">5.3 Content Moderation</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">6. Intellectual Property Rights</h2>
            
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">6.1 Our Rights</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">6.2 Third-Party Content</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">6.3 License to Use</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">7. Privacy and Data Protection</h2>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">8. Payment Terms</h2>
            
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">8.1 Subscription Fees</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">8.2 Free Trial</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">8.3 Refunds</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">9. Service Availability</h2>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">10. Disclaimers and Limitations</h2>
            
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">10.1 Medical Disclaimer</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">10.2 Service Disclaimer</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">10.3 Limitation of Liability</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">11. Termination</h2>
            
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">11.1 Termination by You</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
              You may terminate your account at any time by contacting us or using the account deletion 
              feature in the app settings.
            </p>

            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">11.2 Termination by Us</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
              We may suspend or terminate your account if you violate these Terms or for other reasons 
              as permitted by law.
            </p>

            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">11.3 Effect of Termination</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">12. Dispute Resolution</h2>
            
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">12.1 Governing Law</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
              These Terms are governed by the laws of [Jurisdiction], without regard to conflict of law principles.
            </p>

            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">12.2 Dispute Resolution Process</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
            ...
            <h3 className="text-xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-3">12.3 Arbitration</h3>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">13. Changes to Terms</h2>
            <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#2C3E50] dark:text-[#E8EDF2] mb-4">14. Contact Information</h2>
            <div className="bg-[#D4E7F7] dark:bg-[#1A1F2E] p-4 rounded-lg border border-[#E8EEF2] dark:border-[#6B5B8C]">
              <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-2"><strong>Legal Department:</strong></p>
              <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-2">Email: legal@ausmoapp.com</p>
              ...
              <p className="text-[#2C3E50] dark:text-[#E8EDF2] mt-4 mb-2"><strong>General Support:</strong></p>
              <p className="text-[#2C3E50] dark:text-[#E8EDF2] mb-2">Email: support@ausmoapp.com</p>
            </div>
          </section>
        </div>
      </div>
