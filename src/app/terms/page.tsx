      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">3.2 Age Requirements</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">4.1 Permitted Uses</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">4.2 Prohibited Uses</h3>
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">5.1 Content Ownership</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">5.2 Content Standards</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">All uploaded content must:</p>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">5.3 Content Moderation</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">6. Intellectual Property Rights</h2>
            
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">6.1 Our Rights</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">6.2 Third-Party Content</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">6.3 License to Use</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">8.1 Subscription Fees</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">8.2 Free Trial</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">8.3 Refunds</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">10. Disclaimers and Limitations</h2>
            
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">10.1 Medical Disclaimer</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">10.2 Service Disclaimer</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">10.3 Limitation of Liability</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">11.1 Termination by You</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              You may terminate your account at any time by contacting us or using the account deletion 
              feature in the app settings.
            </p>

            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">11.2 Termination by Us</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              We may suspend or terminate your account if you violate these Terms or for other reasons 
              as permitted by law.
            </p>

            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">11.3 Effect of Termination</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">12.1 Governing Law</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              These Terms are governed by the laws of [Jurisdiction], without regard to conflict of law principles.
            </p>

            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">12.2 Dispute Resolution Process</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-3">12.3 Arbitration</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
