      ...
      <div className="max-w-4xl mx-auto px-4 py-24">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-800/50 rounded-lg shadow-lg p-8 space-y-8 border border-gray-200 dark:border-gray-700">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">3.2 Age Requirements</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">4.1 Permitted Uses</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">4.2 Prohibited Uses</h3>
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">6.3 License to Use</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">8.1 Subscription Fees</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">8.2 Free Trial</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">8.3 Refunds</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">10.2 Service Disclaimer</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">10.3 Limitation of Liability</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">11.1 Termination by You</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
              You may terminate your account at any time by contacting us or using the account deletion 
              feature in the app settings.
            </p>

            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">11.2 Termination by Us</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">12.3 Arbitration</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
