      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">8.1 GDPR Rights (EU Users)</h3>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-3">8.2 CCPA Rights (California Users)</h3>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">9. Children's Privacy (COPPA)</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-gray-700 mt-4 mb-2"><strong>EU Representative:</strong></p>
              <p className="text-gray-700 mb-2">Email: eu-privacy@ausmoapp.com</p>
              
              <p className="text-gray-700 mt-4 mb-2"><strong>Supervisory Authority:</strong></p>
              <p className="text-gray-700 mb-2">You have the right to lodge a complaint with your local data protection authority.</p>
            </div>
          </section>
        </div>
      </div>
