      ...
      <div className="max-w-4xl mx-auto px-4 py-24">
        ...
        <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-800/50 rounded-lg shadow-lg p-8 space-y-8 border border-gray-200 dark:border-gray-700">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">2.3 Cookies and Tracking</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">8.1 GDPR Rights (EU Users)</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">8.2 CCPA Rights (California Users)</h3>
            <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-4">
